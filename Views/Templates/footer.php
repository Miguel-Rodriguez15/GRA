...
<!--<script src="--><?php echo base_url;?> <!--Assets/js/Chart.bundle.min.js"  crossorigin="anonymous"></script>--->
...
<!--<script src="---><?php echo base_url;?> <!--  Assets/demo/chart-bar-demo.js"></script>--->
      ...
      <!--<script src="<script src="<?php echo base_url;?>Assets/demo/datatables-demo.js"></script>--->
        <script>
